...
$bot->on('text',function()use($store,$draft,$tolong){
  ...
  if($pesan == '/start'){
    ...
    return Bot::sendMessage("Testing pendaftaran pakai bot Telegram..\n\n".$draft[array_keys($draft)[0]]);
  }
...
# respon untuk kasus selain teks
$kasus = 'photo|video|audio|voice|document|sticker|venue|location|inline';
$respon = 'Kirim teks saja ya kak😁';
$bot->on($kasus,$respon);
